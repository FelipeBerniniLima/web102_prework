...
const displayStr = `A total of $${totalPledged.toLocaleString()} has been raised for ${GAMES_JSON.length - numUnfundedGames} games. Currently, ${numUnfundedGames} game${numUnfundedGames !== 1 ? 's' : ''} remains unfunded. We need your help to fund these amazing games!`;
